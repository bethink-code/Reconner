...
export default function Landing() {
  ...
  return (
    <div className="relative min-h-screen bg-[#F5C400] flex flex-col items-center justify-center px-4 py-10">
      ...
      {/* The three pain lines as a close group, a breath, then the lead line as the reply to all three. */}
      <div className="flex flex-col items-center gap-2 mb-5 text-center" style={{ animation: "pageFadeIn 0.6s ease-out" }}>
        <p className="text-[15px] text-[#1A1200]/65">You're turning over good money but you aren't sure where it goes.</p>
        <p className="text-[15px] text-[#1A1200]/65">You're struggling to keep track of your cash.</p>
        <p className="text-[15px] text-[#1A1200]/65">Matching every line against your bank takes you hours.</p>
      </div>

      <p className="font-heading text-[19px] font-light text-[#1A1200] mb-10 text-center" style={{ animation: "pageFadeIn 0.7s ease-out" }}>
      ...
      <a href="https://bethink.co.za" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-1.5 mt-8 no-underline" style={{ animation: "pageFadeIn 0.8s ease-out" }}>
        <span className="text-[12px] font-normal text-[#1A1200] tracking-wide">a TimeShift product by</span>
